...
data "aws_elastic_beanstalk_solution_stack" "php_8_2" {
  most_recent = true
...
resource "aws_elastic_beanstalk_environment" "beanstalkappenv" {
  ...
  solution_stack_name = data.aws_elastic_beanstalk_solution_stack.php_8_2.name
  tier                = "WebServer"
  tags = {
  ...
  setting {
    namespace = "aws:autoscaling:launchconfiguration"
    name      = "RootVolumeSize"
    value     = var.eb_instance_disk_size
  }
  ...
  setting {
    ...
    value     = "tcp, 22, 22, ${var.eb_instance_ssh_restrict}"
  }
  ...
  setting {
    ...
    name      = "MinSize"
    value     = "${var.eb_instance_min_size}"
  }
  setting {
    namespace = "aws:autoscaling:asg"
    name      = "MaxSize"
    value     = "${var.eb_instance_max_size}"
  }
  setting {
